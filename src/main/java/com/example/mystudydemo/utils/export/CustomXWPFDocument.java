...
public class CustomXWPFDocument extends XWPFDocument {
    ...
    public void createPicture1(XWPFParagraph paragraph,int id, int width, int height,String picAttch) throws FileNotFoundException, InvalidFormatException {
        final int EMU = 9525;
        width *= EMU;
        height *= EMU;
        XWPFRun stdMarkRun = paragraph.createRun();
        String blipId = stdMarkRun.getDocument().addPictureData(new FileInputStream(new File(picAttch)),6);
